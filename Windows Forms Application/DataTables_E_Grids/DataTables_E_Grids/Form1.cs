...
namespace DataTables_E_Grids
{
    public partial class Form1 : Form
    {
        ...
        {
            /*if (e.KeyChar == Convert.ToChar((int)Keys.Delete))
                btnApagaLinhaGrid.PerformClick(); */
        ...
        {
            if (dataGridView2.CurrentCell.ColumnIndex == coluna2.Index)
            {
                MessageBox.Show("Você está na coluna 2 : " + 
