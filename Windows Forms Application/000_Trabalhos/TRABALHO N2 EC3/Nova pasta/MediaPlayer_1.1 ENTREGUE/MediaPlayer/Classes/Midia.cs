...
namespace MediaPlayer
{
    public abstract class Midia : Object
    {
        ...
        static string caminhoCadastroTXT = Path.GetDirectoryName(Application.ExecutablePath) + "\\BD\\cadastro.txt";
        ...
        {
            File.AppendAllText(caminhoCadastroTXT, dados + Environment.NewLine, Encoding.Default);
        }
        ...
        {
            File.WriteAllText(caminhoCadastroTXT, null);
            foreach (string linha in cadastro)
            {
                ...
                if (temp[0].Replace("<Id>", "") == p_id.ToString())
                    ...
                    File.AppendAllText(caminhoCadastroTXT, linha + Environment.NewLine, Encoding.Default);
            }
        }
        ...
        public static string[] CarregaCadastroTXT()
        {
            ...
            if (!File.Exists(caminhoCadastroTXT))
                File.WriteAllText(caminhoCadastroTXT, "");

            return File.ReadAllLines(caminhoCadastroTXT, Encoding.Default);
        }
