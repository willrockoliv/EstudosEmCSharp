...
namespace MediaPlayer
{
    ...
    public partial class frPrincipal : Form
    {
        ...
        private void frPrincipal_Load(object sender, EventArgs e)
        {
            ...
            string caminhoPlaylistTXT = caminhoBD + "\\playlist.txt";
        ...
        private void BtnPlayPilha_Click(object sender, EventArgs e)
        {
            ...
            PlayerPrincipal.URL = (Path.GetDirectoryName(Application.ExecutablePath) + caminho); //pilha.Desempilhar().ArquivoDeDados + "\\" + pilha.Desempilhar().Descricao);
        ...
        {
            if (PlayerPrincipal.playState == WMPPlayState.wmppsMediaEnded)
                Close();
        }
    }
}
