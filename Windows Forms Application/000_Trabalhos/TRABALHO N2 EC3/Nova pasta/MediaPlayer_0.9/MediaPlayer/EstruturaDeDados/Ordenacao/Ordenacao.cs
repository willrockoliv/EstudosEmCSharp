...
namespace MediaPlayer.EstruturaDeDados.Ordenacao
{
    public class Ordenacao
    {
        ...
        /// <summary>
        /// Ordena os cadastros em uma Lista por ordem alfabética
        /// </summary>
        /// <param name="cadastro">vetor com as linhas de cadastro.txt</param>
        /// <returns>ListaDinamica ordenada alfabéticamente</returns>
        public static ListaDinamica OrdenaListaCadastros(string[] cadastro)
        {
            ListaDinamica ListaCadastros = new ListaDinamica();
            FilaDinamica FilaCadastros = Ordenacao.OrdenaFilaPorDescricao(cadastro);
            while (FilaCadastros.Tamanho() != 0)
            {
                Midia m = FilaCadastros.Desenfileira();
                ListaCadastros.InserirNoFim(Midia.Consultar(m.Id));
            }
