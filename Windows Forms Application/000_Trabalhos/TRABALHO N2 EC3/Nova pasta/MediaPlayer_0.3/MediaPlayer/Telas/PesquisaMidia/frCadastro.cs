...
namespace MediaPlayer
{
    public partial class frCadastro : Form
    {
        ...
        static void Salvar(Midia midia)
        {
            if (midia is Video)
            {
                midia.Inclui((midia as Video).ToString(), (midia as Video).Id);
            }
            else if (midia is Foto)
            {
                midia.Inclui((midia as Foto).ToString(), (midia as Foto).Id);
            }
            else if (midia is Musica)
            {
                midia.Inclui((midia as Musica).ToString(), (midia as Musica).Id);
            }
        }
