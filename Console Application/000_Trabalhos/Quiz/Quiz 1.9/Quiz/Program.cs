...
namespace Quiz
{
    class Program
    {
        ...
        /// <summary>
        /// Struct para armazenar informações primárias
        /// </summary>
        struct Quiz
        {
        ...
        /// <summary>
        /// Struct para armazenar informações do arquivo depois do usuário ter ecolhido o tema e a quantidade de perguntas
        /// </summary>
        ...
        /// <summary>
        /// Struct para armazenar informações sorteadas para iniciar o jogo
        /// </summary>
        struct Sorteadas
        {
            public string pergunta, correta, alt1, alt2, alt3, alt4;
        ...
        #region Game Over
        /// <summary>
        /// Método para mostrar Game Over quando o jogador perder
        /// </summary>
        ...
        #region Parabens
        /// <summary>
        /// Método para mostrar Parabéns caso o jogador vença
        /// </summary>
    ...
    "             /       \\      |");
        ...
        /// <summary>
        /// Método para carregar as informações do arquivo QUIZ.TXT
        /// </summary>
        /// <returns>Vetor string com cada linha do arquivo</returns>
        static string[] CarregaArquivoQuiz()
        {
            ...
            {
                arquivo = File.ReadAllLines("QUIZ.TXT", Encoding.Default);
            }
            return arquivo;
        }

        /// <summary>
        /// metodo para retornar quantidade de perguntas disponíveis em cada tema
        /// </summary>
        /// <param name="quiz"></param>
        /// <param name="arquivo"></param>
        /// <returns>Quantidade de perguntas disponíveis para cada tema</returns>
        ...
        /// <summary>
        /// mostra temas disponiveis no arquivo
        /// </summary>
        /// <param name="qtd_perguntas_por_tema"></param>
        /// <returns>retorna escolha do usuário</returns>
        static string Menu_tema_escolhido(string[] qtd_perguntas_por_tema)
        {
            ...
            foreach (string tema in qtd_perguntas_por_tema)
            {
                if (qtd_perguntas_por_tema[i] == null)
                    ...
                    break;
                Console.WriteLine("\n < {0} > {1}", i + 1, qtd_perguntas_por_tema[i].Split('|')[1]);
                i++;
            }
            ok = false;
            do
        ...
        /// <summary>
        ///  Menu para escolha de quantidade de perguntas que deseja responder
        /// </summary>
        /// <param name="menu"></param>
        /// <returns>Escolha do jogador</returns>
        ...
        /// <summary>
        /// Sorteia números aleatórios para sorteio de perguntas
        /// </summary>
        /// <param name="qtd_perguntas"></param>
        /// <returns>Vetor de inteiros aleatórios</returns>
        ...
        /// <summary>
        /// Esse método testa se a resposta do usuário é válida
        /// </summary>
        /// <param name="s_ou_n"></param>
        ...
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                for (int i = 0; i < menu.qtd_perguntas; i++)
                {
                    ...
                    double tempo = menu.qtd_perguntas * 15;
                    ...
                    do
                    {
                        ...
                        Console.WriteLine("TEMPO: " + (15 - Math.Truncate(tempo)) + "SEG");
                        if (Console.KeyAvailable)
                        {
                            ...
                            else if (char.ToUpper(resposta) == 'B')
                            {
                                resposta = 'b';
                                break;
                            }
                            else if (char.ToUpper(resposta) == 'C')
                            {
                                resposta = 'c';
                                break;
                            }
                            else if (char.ToUpper(resposta) == 'D')
                            {
                                resposta = 'd';
                                break;
                            }
                    ...
                    while (tempo <= menu.qtd_perguntas * 15);
