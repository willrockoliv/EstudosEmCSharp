...
"   /       \\      |");
        ...
        static int Menu_qtd_perguntas(Quiz menu)
        {
            ...
            if (menu.tema_escolhido[0] == '1')
                ...
                Console.WriteLine("\n >> Esse tema possui {0} pergunta disponíveis", menu.tema_escolhido[0]);
            ok = false;
            do
            {
                try
        ...
        static void ExibePergutas(int[] numeros, Quiz[] quiz, string tema_escolhido)
        {
            Console.Clear();
            int i = 0, j = 1;
            foreach(char pergunta in quiz[i].pergunta)
            {
                if(quiz[i].tema == tema_escolhido)
                {
                    Console.WriteLine(j + ") " + quiz[numeros[i]].pergunta);
                    Console.WriteLine("\n Alternativas:");
                    Console.WriteLine("< a > " + quiz[numeros[i]].alt1);
                    Console.WriteLine("< b > " + quiz[numeros[i]].alt2);
                    Console.WriteLine("< c > " + quiz[numeros[i]].alt3);
                    Console.WriteLine("< d > " + quiz[numeros[i]].alt4);
                    ArmazenaResposta(Console.ReadLine());
        ...
        static void ArmazenaResposta(string resposta)
        {
        ...
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                ExibePergutas(numeros, quiz, menu.tema_escolhido);
